...
<div class="auth-shell">
    ...
    <aside class="brand-panel">
        ...
        <div style="position:relative;" class="text-center max-w-md mx-auto py-8">
            ...
            <img src="<?php echo e(asset('assets/images/brand/salal-collection.png')); ?>" alt="Salal Collection" style="width:110px;height:110px;object-fit:contain;margin:0 auto 10px;display:block;border-radius:9999px;box-shadow:0 8px 24px rgba(0,0,0,.25);">
        ...
        <div style="position:relative;" class="text-center text-xs text-sky-100/60">
            &copy; <?php echo e(now()->year); ?> Salal Collection. All rights reserved.
        </div>
    </aside>
...
<?php /**PATH /Users/mhtech/Documents/Practive-Laravel-Projects/salalcollection/resources/views/layouts/guest.blade.php ENDPATH**/ ?>